...
CREATE TABLE Consultas(
    ...
    FOREIGN KEY (idAfiliado) REFERENCES Afiliado(idAfiliado) ON DELETE CASCADE,
    FOREIGN KEY(idServicio) REFERENCES ServiciosSalud(idServicio) ON DELETE CASCADE
);
...
DROP SEQUENCE AFILIADO_SEQ;
DROP SEQUENCE MEDICO_SEQ;
DROP SEQUENCE IPS_SEQUENCE;
DROP SEQUENCE SERVICIO_SEQUENCE;
