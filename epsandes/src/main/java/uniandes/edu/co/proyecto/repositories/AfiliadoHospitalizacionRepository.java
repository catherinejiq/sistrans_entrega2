...
public interface AfiliadoHospitalizacionRepository extends JpaRepository<AfiliadoHospitalizacionEntity, AfiliadoHospitalizacionPK> {
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE Hospitalizacion_Afiliado SET idAfiliado = :idAfiliadoNuevo, idHospitalizacion = :idHospitalizacionNuevo " +
                   "WHERE idAfiliado = :idAfiliado AND idHospitalizacion = :idHospitalizacion", nativeQuery = true)
    void actualizarAfiliadoHospitalizacion(@Param("idAfiliado") Integer idAfiliado, 
                                           @Param("idHospitalizacion") Integer idHospitalizacion,
                                           @Param("idAfiliadoNuevo") Integer idAfiliadoNuevo, 
                                           @Param("idHospitalizacionNuevo") Integer idHospitalizacionNuevo);
